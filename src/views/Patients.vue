 ...
 <template v-slot:item.actions="{ item }">
  ...
  >
     <v-card>
      ...
      rounded
    >
         <v-toolbar-title class="mx-4">Edit Patient Information</v-toolbar-title>
          <v-spacer></v-spacer>
           <v-icon 
  ...
  >
    ...
    >
         <v-toolbar-title class="mx-4">Delete Patient</v-toolbar-title>
          ...
          class='mx-4'
           @click="deleteDialog=false">mdi-close</v-icon>
          ...
          <v-container>
            ...
            <v-row justify="center">
               <v-card-title > <h4>Are you sure you want to delete this patient?</h4></v-card-title>
                <v-card-text>
                  <v-row justify="center">
               <v-col
                cols="12"
                md="4"
              >
               <h5> Patient Name:<h6>{{toDeletePatient.name}}</h6></h5>  
                 </v-col>
                 <v-col
                cols="12"
                md="4"
              >
                <h5> Amka: <h6>{{toDeletePatient.amka}}</h6></h5> 
              </v-col>
              </v-row>
   ...
   methods: {
     ...
     getColor (status) {
      ...
      this.color2="#9ce690"
       ...
       this.snackbar2=true
       this.color2="#e17b58"
       this.text2="Couldn't delete patient. Please check your internet connection"
     ...
     async editPatient(){
      ...
      this.color2="#9ce690"
         this.initPatients()}catch(error){
       this.snackbar2=true
       this.color2="#e17b58"
       this.text2="Couldn't edit patient. Please check your internet connection"
        console.log("something went wrong here",error)
